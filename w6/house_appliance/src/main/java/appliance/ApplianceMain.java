...
public class ApplianceMain {
    ...
    public static void main(String[] args) {
        PowerSource grid = new PowerSource(12000, "Grid");
        PowerSource solar = new PowerSource(700, "Solar");
        PowerSource battery = new PowerSource(1500, "Battery");
        ...
        SimpleRefrigerator refrigerator1 = new SimpleRefrigerator("Refrigerator 1");
